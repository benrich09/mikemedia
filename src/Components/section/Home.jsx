        ...
        <RevealOnScroll>
            ...
            <div className="text-center z-10 px-4">
                ...
                <p className="text-grey-400 text-lg mb-8 max-w-lg mx-auto">
                    Media ya Tanzania Inayo jihusisha na kuhabarisha Ndani na nje ya Taifa
                    Kwa habari za Siasa, Michezo na Burudani
                </p>

                <div className="flex justify-center space-x-4">
                    <a href="#projects"
                       className="bg-blue-500 text-white py-3 px-6 rounded font-medium transtion relative overflow-hidden
                    ...
                    <a href="#contact"
                       className="border border-blue-500/50 text-blue-500 py-3 px-6 rounded font-medium transition-all
                              duration-200 hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59, 130, 246, 0.4)]
